...
from falconcpkg/gfftools import nil
    ...
    dispatchMulti(
        ...
        [overlapFilter.m4filtRunner, cmdName = "m4filt",
         help = {
          ...
          "min-avg-cov" : "minimum average coverage for chimera filter, reads with coverage < N, will not be marked as chimeric.",
        ...
        [gfftools.gffsubtract, cmdName = "gfftools-gffsubtract",
        ],
